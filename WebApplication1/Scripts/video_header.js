    ...
    var appendTeaserVideo = function() {
        if(Modernizr.video && !isMobile()) {
            var source = videoDetails.teaser,
                html = '<video autoplay="true" loop="loop" muted id="teaser-video" class="teaser-video"><source src="/video/intro.mp4" type="video/mp4"><source src="/video/intro.ogv" type="video/ogg"></video>';
