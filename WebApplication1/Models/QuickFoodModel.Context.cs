...
namespace WebApplication1.Models
{
    ...
    public partial class QuickFoodEntities : DbContext
    {
        ...
        public virtual int UpdateUser(Nullable<int> userId, string firstName, string surName, string mail)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateUser", userIdParameter, firstNameParameter, surNameParameter, mailParameter);
        }
    }
}
